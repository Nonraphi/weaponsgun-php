...
<head>
    ...
    <link rel="stylesheet" href="../public/css/LightMachineGuns.css">
...
<body>
    ...
    <section>
        <div class="header-content">
            <h1>LightMachineGuns</h1>
        </div>
        <div class="info-item">
            <p>ปืนกลเบา (LMG) เป็นอาวุธปืนสำหรับนักแม่นปืนกราดกระสุนเป็นจำนวนมากใส่ศัตรู</p>
        </div>
        ...
        <div class="container-content">
            ...
            $stmt = $conn->query("SELECT * FROM table_weapon 
                                ...
                                WHERE table_type.typeName = 'LightmachineGuns'
    ...
    <div class="pagination">
        ...
        $stmt_count = $conn->query("SELECT COUNT(*) AS total FROM table_weapon WHERE type = 6");
