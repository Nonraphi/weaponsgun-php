...
<head>
    ...
    <link rel="stylesheet" href="../public/css/Shotguns.css">
...
<body>
    ...
    <section>
        ...
        <div class="info-item">
            <p>ปืนลูกซอง (SG) เป็นอาวุธที่ใช้ยิงกระสุนที่บรรจุกระสุนที่กระจายไปทั่วพื้นที่
                มันมีประสิทธิภาพในการจัดการกับภัยคุกคามในการเผชิญหน้าระยะใกล้ที่เกิดขึ้นเอง</p>
        </div>
        ...
        <div class="container-content">
            ...
            $stmt = $conn->query("SELECT * FROM table_weapon 
                                ...
                                WHERE table_type.typeName = 'Shotguns'
    ...
    <div class="pagination">
        ...
        $stmt_count = $conn->query("SELECT COUNT(*) AS total FROM table_weapon WHERE type = 4");
