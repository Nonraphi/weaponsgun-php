...
<head>
    ...
    <link rel="stylesheet" href="../public/css/SniperRifles.css">
...
<body>
    ...
    <section>
        ...
        <div class="info-item">
            <p>ปืนไรเฟิลซุ่มยิง (SR) ให้ความแม่นยำและความเสียหายสูง เหมาะสำหรับจัดการกับศัตรูในระยะไกล</p>
        </div>
        ...
        <div class="container-content">
            ...
            $stmt = $conn->query("SELECT * FROM table_weapon 
                                ...
                                WHERE table_type.typeName = 'SniperRifles'
    ...
    <div class="pagination">
        ...
        $stmt_count = $conn->query("SELECT COUNT(*) AS total FROM table_weapon WHERE type = 5");
