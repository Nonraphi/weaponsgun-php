...
<head>
    ...
    <link rel="stylesheet" href="../public/css/AssaultRifles.css">
...
<body>
    ...
    <section>
        ...
        <div class="info-item">
            <p>ปืนไรเฟิลจู่โจม (AR) เป็นอาวุธอเนกประสงค์ที่สร้างความเสียหายและอัตราการยิงที่เหมาะสม
                และช่วยให้คุณเอาชนะศัตรูในระยะกลางในสถานการณ์การต่อสู้ต่างๆ</p>
        </div>
        ...
        <div class="container-content">
            ...
            $stmt = $conn->query("SELECT * FROM table_weapon 
                                ...
                                WHERE table_type.typeName = 'Assault Rifles'
    ...
    <div class="pagination">
        ...
        $stmt_count = $conn->query("SELECT COUNT(*) AS total FROM table_weapon WHERE type = 1");
